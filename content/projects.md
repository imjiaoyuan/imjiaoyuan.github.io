...
- **llm**[rust]: A terminal coding agent in a single Rust binary — a REPL-style chat session with steering, tools, sub-agents and MCP as extensions, per-tool approval policies, a searchable conversation store, and multimodal in/out. ［[blog](/60kw6/), [github](https://github.com/imjiaoyuan/llm), [pages](https://jiaoyuan.org/llm/)］
- **recite**[typescript]: A no-framework English vocabulary trainer (DOM built by hand with a hyperscript helper, ~2.8k lines) running FSRS spaced repetition across flashcard study, spelling practice, and listen-and-write dictation, where due reviews always queue ahead of the daily new-word cap and each list keeps its own progress. ［[blog](/9zgxm/), [github](https://github.com/imjiaoyuan/recite), [pages](https://jiaoyuan.org/recite/)］
- **jsrc**[python]: A bioinformatics CLI spanning sequence extraction, genome statistics, phylogeny and gene regulatory network analysis, with lazy-loaded modules and a built-in plotting toolkit. ［[blog](/4kcd2/), [github](https://github.com/imjiaoyuan/jsrc), [pypi](https://pypi.org/project/jsrc/)］
...
- **blog**[python]: A zero-dependency static site generator (~1.4k lines, stdlib only) with CRC24 short-hash URLs, KaTeX math, and no-JS-by-default rendering. ［[blog](/5xbok/), [github](https://github.com/imjiaoyuan/imjiaoyuan.github.io)］
