...
- **llm**[rust]: A terminal-first AI hub in a single Rust binary — one-shot prompting, a chat REPL, an agent with tools and sub-agents, pluggable scripts and MCP servers, a searchable conversation store, and multimodal in/out. ［[github](https://github.com/imjiaoyuan/llm), [pages](https://jiaoyuan.org/llm/)］
