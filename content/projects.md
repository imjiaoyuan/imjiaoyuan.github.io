...
- **llm**[rust]: A terminal-first AI hub in a single Rust binary — one-shot prompting, a chat REPL, a coding agent with tools, sub-agents and MCP, pluggable script tools and resident extensions, a searchable conversation store, and multimodal in/out. ［[blog](/60kw6/), [github](https://github.com/imjiaoyuan/llm), [pages](https://jiaoyuan.org/llm/)］
