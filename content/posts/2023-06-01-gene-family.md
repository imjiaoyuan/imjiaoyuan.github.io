...
![](https://static.jiaoyuan.org/blog/images/63339f42.webp)

我们现在可以看到下方出现一个列表，点击 RAP ID 列的 Os05g0409300 进入该基因的详情页

![](https://static.jiaoyuan.org/blog/images/cec360a2.webp)

再点击 Transcript variants （转录变体）下的基因名称进入该基因转录本的详情页

![](https://static.jiaoyuan.org/blog/images/58e331f8.webp)

下滑到最下方即可得到蛋白质序列，复制下来保存即可

![](https://static.jiaoyuan.org/blog/images/a27d2cb0.webp)
...
![](https://static.jiaoyuan.org/blog/images/ba92b187.webp)

![](https://static.jiaoyuan.org/blog/images/843dd99e.webp)
...
![](https://static.jiaoyuan.org/blog/images/5303ddd3.webp)
...
![](https://static.jiaoyuan.org/blog/images/05e41938.webp)
...
![](https://static.jiaoyuan.org/blog/images/39ba7253.webp)

得出结果后，查看 evalue 这一列，所有的值均小于 10 的-5 次方，我们现在可以认为 HMMER 搜索结果是准确的，这 14 个基因都属于 Cystatin 基因家族

![](https://static.jiaoyuan.org/blog/images/b45a5032.webp)
...
![](https://static.jiaoyuan.org/blog/images/827aa2c5.webp)

然后使用 TBtools 进行可视化

![](https://static.jiaoyuan.org/blog/images/9e9793bd.webp)
...
![](https://static.jiaoyuan.org/blog/images/0df69b16.webp)

然后使用 TBtools 进行可视化

![](https://static.jiaoyuan.org/blog/images/cc924eda.webp)

![](https://static.jiaoyuan.org/blog/images/430a9d4e.webp)
...
![](https://static.jiaoyuan.org/blog/images/a76a49a8.webp)

比对完成后点击左上角的 Data，选择 Phylogenetic Analysis 进行进化树分析

![](https://static.jiaoyuan.org/blog/images/c6ff2a40.webp)

进化树分析完成后，点击上方 Phylogeny，选择 NJ 算法构建进化树

![](https://static.jiaoyuan.org/blog/images/112cbb60.webp)

![](https://static.jiaoyuan.org/blog/images/a3c964e4.webp)
...
![](https://static.jiaoyuan.org/blog/images/f3ccedac.webp)
...
![](https://static.jiaoyuan.org/blog/images/b304d193.webp)

得到分析结果

![](https://static.jiaoyuan.org/blog/images/549ed4db.webp)

### 染色体定位分析

![](https://static.jiaoyuan.org/blog/images/6f46d3fe.webp)

得到染色体位置分布图

![](https://static.jiaoyuan.org/blog/images/a5cb5583.webp)

我们导入重命名文件，使其名称全部变为我们命名的格式

![](https://static.jiaoyuan.org/blog/images/5c194001.webp)

注意重命名文件的格式

![](https://static.jiaoyuan.org/blog/images/e628f072.webp)

可以在这里对颜色和字体进行简单的美化

![](https://static.jiaoyuan.org/blog/images/cef01878.webp)

当然，如果你不想对它们进行统一的更改，可以点击任意一个基因名称，再点击右键对其进行单独的更改，对于染色体的名称也同样适用

调整过后的图就好看了很多

![](https://static.jiaoyuan.org/blog/images/1cb315b3.webp)
...
![](https://static.jiaoyuan.org/blog/images/e625c3fc.webp)

![](https://static.jiaoyuan.org/blog/images/24551f2c.webp)

### 基因表达量分析

首先在 [Rice Expression Database](http://expression.ic4r.org) 中搜索基因列表

![](https://static.jiaoyuan.org/blog/images/8d8fd381.webp)

选择 DRP000391 这个项目

![](https://static.jiaoyuan.org/blog/images/20802280.webp)
...
![](https://static.jiaoyuan.org/blog/images/c45066ae.webp)

整理成如下样式

![](https://static.jiaoyuan.org/blog/images/222e52a7.webp)

然后对数据进行 LOG2 处理，如果出现#NUM! 字样，全部改为 0

![](https://static.jiaoyuan.org/blog/images/3ae0a406.webp)

重新整理得到最终数据，打开 TBtools 的 Heat Map 功能，把刚刚整理的数据粘贴进去进行绘图

![](https://static.jiaoyuan.org/blog/images/42aba432.webp)

得到基因家族的表达热图

![](https://static.jiaoyuan.org/blog/images/ddcb8379.webp)

对基因进行重命名即将复制进去的表格中的基因名称进行修改即可

![](https://static.jiaoyuan.org/blog/images/42676eec.webp)

然后重新制图

![](https://static.jiaoyuan.org/blog/images/5d1317d3.webp)
...
![](https://static.jiaoyuan.org/blog/images/d64d36ed.webp)

搜索完成后就得到了蛋白质的互相作用网络

![](https://static.jiaoyuan.org/blog/images/2ac5607a.webp)

点击每一个圆珠我们就可以查看其信息，包括基因 ID、物种等，圆珠直接的黑色线条表示共表达蛋白质，黄色线条表示在其他生物体中共同提及推定的同源物。

![](https://static.jiaoyuan.org/blog/images/aaba5817.webp)
...
![](https://static.jiaoyuan.org/blog/images/38ee6422.webp)

然后提取目标基因的启动子序列，打开 TBtools 的 Fasta Extract or Filter，设置好序列文件、输出文件、基因 ID，点击 start 开始

![](https://static.jiaoyuan.org/blog/images/42eed897.webp)

打开 Sequenxe Manipulate 工具，将提取出来的所有序列复制进去，全部转为大写

![](https://static.jiaoyuan.org/blog/images/924fe1c2.webp)

新建文本文档保存转换后的序列

现在需要打开网站 http://bioinformatics.psb.ugent.be/webtools/plantcare/html/ 将刚刚保存的序列上传进行顺势作用元件预测

![](https://static.jiaoyuan.org/blog/images/47fcb587.webp)

![](https://static.jiaoyuan.org/blog/images/07b8878a.webp)

等待一会后会收到网站发出的一封邮件，下载邮件中的附件然后解压，解压之后得到一个拓展名为 tar 的文件，再进行解压

![](https://static.jiaoyuan.org/blog/images/b683da1f.webp)

用 excel 打开解压出来的 tab 文件，此时 excel 中显示的就是这些基因的元件信息

![](https://static.jiaoyuan.org/blog/images/dae4bcf5.webp)

筛选我们需要的物种，这里我选择了水稻

![](https://static.jiaoyuan.org/blog/images/a48a58bd.webp)
...
![](https://static.jiaoyuan.org/blog/images/4252b6f4.webp)

下面需要再新建一个关于序列长度的文件，格式如下：

![](https://static.jiaoyuan.org/blog/images/8bd83f1f.webp)

打开 TBtools 的 Simple BioSequence Viewer 功能，导入长度信息文件和元件信息，点击 start 开始

![](https://static.jiaoyuan.org/blog/images/7cd38ec7.webp)

最终得到可视化结果

![](https://static.jiaoyuan.org/blog/images/a5144f3f.webp)

这是我做的顺式作用元件分析的图，可以对其进行简一些美化

![](https://static.jiaoyuan.org/blog/images/ce282186.webp)

### 多序列比对

在 [CLUSTALW 网站](https://www.genome.jp/tools-bin/clustalw) 上传基因家族的蛋白质序列进行多序列比对，比对完成后下载比对结果的 aln 文件

![](https://static.jiaoyuan.org/blog/images/d4a9768f.webp)

打开 [ESPript](https://espript.ibcp.fr/ESPript/cgi-bin/ESPript.cgi) ，上传刚刚的 aln 文件进行可视化

![](https://static.jiaoyuan.org/blog/images/ebbbc0bf.webp)

下载结果中的 pdf 文件打开后即可得到多序列比对的图像

![](https://static.jiaoyuan.org/blog/images/b8c1d6d4.webp)
...
![](https://static.jiaoyuan.org/blog/images/3f091ac2.webp)

打开 TBtools 的 Advanced Circos 功能，依次导入 chr len.txt、GenePairTable.txt、LinkedRegion.txt 进行绘图

![](https://static.jiaoyuan.org/blog/images/f3e46157.webp)

这样就得到拟南芥所有基因的共线性分析 Circos 图了

![](https://static.jiaoyuan.org/blog/images/97ca22aa.webp)
...
![](https://static.jiaoyuan.org/blog/images/97392557.webp)

然后生成新的关联文件 LinkedRegion

![](https://static.jiaoyuan.org/blog/images/5da7c379.webp)

然后将新的 LinkedRegion.txt 文件的内容复制到 Excel 中，最后一列加上 RGB 色值

![](https://static.jiaoyuan.org/blog/images/734018ba.webp)
...
![](https://static.jiaoyuan.org/blog/images/4808366c.webp)
...
![](https://static.jiaoyuan.org/blog/images/79f1ca01.webp)

**进化树+Motif+Domain**

![](https://static.jiaoyuan.org/blog/images/63ee7dc8.webp)

**进化树+Motif+Domain+显示外显子、内含子**

![](https://static.jiaoyuan.org/blog/images/d25d275a.webp)

**进化树+Motif+Domain+显示外显子、内含子+顺式作用元件**

![](https://static.jiaoyuan.org/blog/images/f52bcd94.webp)

最终得到一张信息整合的图

![](https://static.jiaoyuan.org/blog/images/5592d3c1.webp)
...
![](https://static.jiaoyuan.org/blog/images/50231604.webp)

如果想对基因进行重命名，准备好重命名文件，文件格式与染色体定位分析时的一样

在下列位置导入重命名文件

![](https://static.jiaoyuan.org/blog/images/7d673fb7.webp)

另外，如果我们不要进化树，比如在基因很少或只有单条基因的时候，可能无法做出进化树或者进化树很稀疏，那么我们可以不用导入进化树，在 Gene Structure View 功能填写进化树信息的地方我们填入基因列表即可

![](https://static.jiaoyuan.org/blog/images/acb69ce6.webp)

得出图像

![](https://static.jiaoyuan.org/blog/images/c9b743c4.webp)
...
![](https://static.jiaoyuan.org/blog/images/db022075.webp)
...
![](https://static.jiaoyuan.org/blog/images/e81db8cb.webp)

打开 DAVID 官网：https://david.ncifcrf.gov/

点击上方功能菜单 Functional Annotation

![](https://static.jiaoyuan.org/blog/images/ab203457.webp)

选择上方的 upload 选项卡，在编辑框内粘贴基因 ID 列表，选 ID 类型为 ENSEMBL_GENE_ID  ，选择列表类型为基因列表，最后上传列表

![](https://static.jiaoyuan.org/blog/images/ce225aa9.webp)
...
![](https://static.jiaoyuan.org/blog/images/80fe39cf.webp)
...
![](https://static.jiaoyuan.org/blog/images/fc2edb90.webp)

对数据进行整理，简化一下名称，最终得到如下数据

![](https://static.jiaoyuan.org/blog/images/deb4c492.webp)

打开微生信平台（http://www.bioinformatics.com.cn/）的富集气泡图功能进行绘图，也可以使用 R 和 Excel，R 的环境比较复杂，这里我就不放代码了。

![](https://static.jiaoyuan.org/blog/images/ebe773be.webp)
