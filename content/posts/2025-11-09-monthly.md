...
![](https://static.jiaoyuan.org/blog/images/7fb21bd4.webp)
...
![](https://static.jiaoyuan.org/blog/images/e0e3b5e1.webp)

（公众号上扒下来的图片，上面是自己改的 Hexo 主题，下面是自己改的 Hugo 主题，模糊到看不清了😂）

再后来就一直用 [PaperMod](https://github.com/adityatelange/hugo-PaperMod) 主题，删掉了一些多余的东西。
...
![](https://static.jiaoyuan.org/blog/images/a61ebf7e.webp)
