...
![](img/20230601194409.png)

![](img/20230601194438.png)
...
![](img/20230601195521.png)

然后使用 TBtools 进行可视化

![](img/20230601195739.png)

![](img/20230601195751.png)
...
![](img/20230601195838.png)

然后使用 TBtools 进行可视化

![](img/20230601195927.png)

![](img/20230601195942.png)
...
![](img/20230601200515.png)

比对完成后点击左上角的 Data，选择 Phylogenetic Analysis 进行进化树分析

![](img/20230601200615.png)

进化树分析完成后，点击上方 Phylogeny，选择 NJ 算法构建进化树

![](img/20230601200701.png)

![](img/20230601200724.png)
...
![](img/20230601200843.png)

得到分析结果

![](img/20230601200902.png)

### 染色体定位分析

![](img/20230601201108.png)

得到染色体位置分布图

![](img/20230601201134.png)

我们导入重命名文件，使其名称全部变为我们命名的格式

![](img/20230601201151.png)

注意重命名文件的格式

![](img/20230601201453.png)

可以在这里对颜色和字体进行简单的美化

![](img/20230601201539.png)

当然，如果你不想对它们进行统一的更改，可以点击任意一个基因名称，再点击右键对其进行单独的更改，对于染色体的名称也同样适用

调整过后的图就好看了很多

![](img/20230601201554.png)
...
![](img/20230601201651.png)

![](img/20230601201710.png)

### 基因表达量分析

首先在 [Rice Expression Database](http://expression.ic4r.org) 中搜索基因列表

![](img/20230601201730.png)

选择 DRP000391 这个项目

![](img/20230601201742.png)
...
![](img/20230601201850.png)

整理成如下样式

![](img/20230601202026.png)

然后对数据进行 LOG2 处理，如果出现#NUM! 字样，全部改为 0

![](img/20230601202044.png)

重新整理得到最终数据，打开 TBtools 的 Heat Map 功能，把刚刚整理的数据粘贴进去进行绘图

![](img/20230601202109.png)

得到基因家族的表达热图

![](img/20230601202126.png)

对基因进行重命名即将复制进去的表格中的基因名称进行修改即可

![](img/20230601202144.png)

然后重新制图

![](img/20230601202157.png)
...
![](img/20230601202947.png)

**进化树+Motif+Domain**

![](img/20230601203017.png)

**进化树+Motif+Domain+显示外显子、内含子**

![](img/20230601203035.png)

**进化树+Motif+Domain+显示外显子、内含子+顺式作用元件**

![](img/20230601203136.png)

最终得到一张信息整合的图

![](img/20230601203149.png)
