...
![](img/20230424210040.png)

![](img/20230424210131.png)

最后依次输入染色体长度文件、展示 ID 的 GenePairTable 文件、带有 RGB 色值的 LinkedRegion.txt 文件
绘图即可

![](img/20230424210148.png)

最终结果

![](img/20230424210204.png)